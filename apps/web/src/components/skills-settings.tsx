...
import type { Project, ProviderKind, SkillEntry, SkillSource } from '@proofship/client'
...
import { ProviderIcon, providerMeta, WakuIcon } from '@/components/proofship-icon'
...
function availableSkillSources(skills: SkillEntry[], t: Translator) {
  ...
  const ids: Array<Exclude<SkillSourceFilter, 'all'>> = ['shared', 'claude', 'codex', 'cursor', 'openCode', 'pi', 'ohMyPi', 'amp', 'deepSeek', 'grok']
  return [
