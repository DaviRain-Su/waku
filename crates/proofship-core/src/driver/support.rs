...
fn build_grok_computer_use_toml(
    ...
    mcp_servers.insert("proofship_js_repl".into(), toml::Value::Table(server));
...
mod tests {
    ...
    fn computer_use_config() -> computer_use_runtime::ComputerUseConfig {
        computer_use_runtime::ComputerUseConfig {
            ...
            repl_path: PathBuf::from("/Applications/Waku.app/Contents/Resources/proofship_js_repl"),
    ...
    fn opencode_computer_use_config_preserves_existing_inline_config() {
        let content = build_opencode_computer_use_config(
            ...
            Path::new("/Applications/Waku.app/Contents/Resources/proofship_js_repl"),
            Path::new(
                "/Applications/Waku.app/Contents/Resources/skills/waku-computer-use/SKILL.md",
            ),
        ...
        assert_eq!(
            value
                .pointer("/mcp/proofship_js_repl/command/0")
                .and_then(Value::as_str),
            Some("/Applications/Waku.app/Contents/Resources/proofship_js_repl")
        );
        assert_eq!(
            value
                .pointer("/mcp/proofship_js_repl/environment/WAKU_COMPUTER_USE_SERVER")
                .and_then(Value::as_str),
    ...
    fn grok_computer_use_config_preserves_existing_config_and_replaces_waku_server() {
        ...
        let server = value
            .get("mcp_servers")
            .and_then(|mcp| mcp.get("proofship_js_repl"))
            .unwrap();
        assert_eq!(
