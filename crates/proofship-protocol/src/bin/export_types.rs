...
fn generated_output() -> PathBuf {
    Path::new(env!("CARGO_MANIFEST_DIR")).join("../../packages/proofship-client/src/generated")
}
...
fn export_to(output: &Path) -> Result<(), Box<dyn std::error::Error>> {
    ...
    fs::write(
        ...
        format!(
            "// Generated from proofship-protocol. Do not edit.\n\
