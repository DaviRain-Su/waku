---
name: proofship-vercel
description: >-
  ProofShip Vercel hosting via the official MCP. Use when the user wants to
...
Settings → MCP has the Vercel row **on**. The coding agent opens ProofShip's
