...
AppPublisher=ProofShip
AppPublisherURL=https://waku.sh
AppSupportURL=https://github.com/DaviRain-Su/waku/issues
AppUpdatesURL=https://github.com/DaviRain-Su/waku/releases
DefaultDirName={autopf}\ProofShip
DefaultGroupName=ProofShip
UninstallDisplayName=ProofShip
UninstallDisplayIcon={app}\proofship.exe
LicenseFile={#StageDir}\LICENSE
OutputDir={#OutputDir}
OutputBaseFilename=ProofShip-{#AppVersion}-{#Arch}-Setup
...
; ProofShip persists continuously to SQLite, so closing it is safe; a silent
; update cannot stop to ask, and a locked proofship.exe would fail the install.
...
[Files]
Source: "{#StageDir}\proofship.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#StageDir}\proofship-daemon.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#StageDir}\proofship-pf-mcp.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#StageDir}\LICENSE"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
Name: "{group}\ProofShip"; Filename: "{app}\proofship.exe"
Name: "{userdesktop}\ProofShip"; Filename: "{app}\proofship.exe"; Tasks: desktopicon

[Tasks]
Name: "desktopicon"; Description: "{cm:CreateDesktopIcon}"; Flags: unchecked

[Run]
; No skipifsilent: this is also how the updater's silent run brings ProofShip back.
Filename: "{app}\proofship.exe"; Description: "{cm:LaunchProgram,ProofShip}"; Flags: nowait postinstall
