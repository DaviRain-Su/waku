...
pub struct Waku {
    ...
    web3_okx_input: Entity<TextInput>,
    ...
    mcp_cf_input: Entity<TextInput>,
    mcp_vercel_input: Entity<TextInput>,
    mcp_github_input: Entity<TextInput>,
...
impl Waku {
    ...
    pub fn new(
        ...
        window.set_rem_size(px(proofship_client::persistence::sanitized_ui_font_size(
            state.ui_font_size,
        )));
        ...
        let web3_okx_input =
            cx.new(|cx| TextInput::new(window, cx).placeholder(tr!("web3.okx_key_placeholder")));
        let mcp_cf_input = cx.new(|cx| {
            TextInput::new(window, cx).placeholder(tr!("mcp.cloudflare_token_placeholder"))
        });
        let mcp_vercel_input = cx
            .new(|cx| TextInput::new(window, cx).placeholder(tr!("mcp.vercel_token_placeholder")));
        let mcp_github_input = cx
            .new(|cx| TextInput::new(window, cx).placeholder(tr!("mcp.github_token_placeholder")));
