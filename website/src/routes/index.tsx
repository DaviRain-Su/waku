...
const FEATURES = [
  ...
  },
  {
    ...
    body: 'Projects, sessions, transcripts, and provider IDs live on your disk. No account, no telemetry, no ProofShip cloud between you and your agents.',
  },
  {
    icon: RefreshCw,
...
const FAQ = [
  {
    ...
    a: 'No. ProofShip is a single Rust binary rendered by GPUI, the UI framework Zed is built on. The window you see is drawn by the GPU, not by a browser engine.',
  },
  {
    q: 'Do I need new API keys?',
    a: 'No. ProofShip detects amp, claude, codex, cursor-agent, opencode, grok, pi, omp, and kimi on your machine and drives them directly — your existing logins, plans, and rate limits apply unchanged.',
  },
  {
    q: 'Where does my data live?',
    a: 'On your machine. Projects, sessions, transcripts, and provider session IDs are stored locally. There is no ProofShip account and no telemetry.',
  },
  {
            ...
            <section>
              <picture>
                ...
                <img
                  ...
                  alt="ProofShip showing a coding-agent session"
                  width={2266}
                  height={1752}
